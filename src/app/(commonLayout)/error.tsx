...
export default function CommonLayoutError({ error, reset }: ErrorProps) {
    useEffect(() => {
        console.error("[CommonLayout Error]", error);
    }, [error]);
        ...
        <div className="min-h-screen bg-[#FAF7F2] relative overflow-hidden flex items-center justify-center">
            ...
            <div className="relative text-center px-6 max-w-lg mx-auto">
                ...
                <div className="flex items-center justify-center gap-4 flex-wrap">
                    ...
                    <Link
                        href="/"
                        className="px-8 py-3 rounded-xl font-semibold border-2 border-neutral-200 text-neutral-700 hover:border-[#e10101] hover:text-[#e10101] transition-all duration-300">
                        Go Home
                    </Link>
                </div>
            </div>
